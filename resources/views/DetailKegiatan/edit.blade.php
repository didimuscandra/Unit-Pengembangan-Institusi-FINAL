...
<div class="row">
  <div class="col-sm-12">  
    <div class="white-box">
      <center><h3 class="box-title">Edit Detail Kegiatan</h3></center></br>   
      <form action="/detailkegiatan/edit/{{$detailkegiatans->id}}" method="post" class="form-horizontal form-material">
      {{ csrf_field() }}
